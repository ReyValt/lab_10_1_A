...
namespace UnitTest
{
	...
	public:
        TEST_METHOD(TestCreate)
        {
            ...
            Assert::AreEqual(2, static_cast<int>(students[2].major));
        ...
        TEST_METHOD(TestCalculateAverages)
        {
            ...
            Assert::IsTrue(output.find("Середній бал з інформатики: 4.66667") != std::string::npos);
